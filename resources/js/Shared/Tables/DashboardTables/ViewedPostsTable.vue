...
import { ViewedPost, UserData } from '@/Interfaces/DashboardData'
...
type tableColumns = {
    name: string;
    label: string;
    field: string | ((row: ViewedPost) => string | number | UserData | Status);
    required?: boolean;
...
const columns:tableColumns[] = [
    ...
    },
    {
        ...
        align: 'left',
        sortable: false,
        field: (row : ViewedPost) => row.user.full_name,
    },
    {
